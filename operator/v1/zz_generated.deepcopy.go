...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapKubeConfigFetcher) DeepCopyInto(out *BootstrapKubeConfigFetcher) {
	*out = *in
	if in.BootstrapKubeConfigFetcherSecretRef != nil {
		in, out := &in.BootstrapKubeConfigFetcherSecretRef, &out.BootstrapKubeConfigFetcherSecretRef
		*out = new(SecretKeyRef)
		**out = **in
	}
	if in.BootstrapKubeConfigFetcherServer != nil {
		in, out := &in.BootstrapKubeConfigFetcherServer, &out.BootstrapKubeConfigFetcherServer
		*out = new(BootstrapKubeConfigFetcherServer)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapKubeConfigFetcher.
func (in *BootstrapKubeConfigFetcher) DeepCopy() *BootstrapKubeConfigFetcher {
	if in == nil {
		return nil
	}
	out := new(BootstrapKubeConfigFetcher)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapKubeConfigFetcherServer) DeepCopyInto(out *BootstrapKubeConfigFetcherServer) {
	*out = *in
	if in.CABundle != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapKubeConfigFetcherServer.
func (in *BootstrapKubeConfigFetcherServer) DeepCopy() *BootstrapKubeConfigFetcherServer {
	if in == nil {
		return nil
	}
	out := new(BootstrapKubeConfigFetcherServer)
...
func (in *RegistrationConfiguration) DeepCopyInto(out *RegistrationConfiguration) {
	*out = *in
	...
	if in.BootstrapKubeConfigFetchers != nil {
		in, out := &in.BootstrapKubeConfigFetchers, &out.BootstrapKubeConfigFetchers
		*out = make([]*BootstrapKubeConfigFetcher, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(BootstrapKubeConfigFetcher)
